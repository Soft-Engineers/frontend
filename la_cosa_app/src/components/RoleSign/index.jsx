...
const RoleSign = () => {
  ...
  let fontWeight = "bold";
  let description =
    "Su objetivo es destruir a todos los Humanos, convirtiéndolos en aliados Infectados o eliminándolos de la partida.";

  if (state.role === "INFECTADO") {
    color = "red";
    description =
      "Su objetivo es trabajar con la Cosa para infectar al resto de los humanos o eliminarlos de la partida";
